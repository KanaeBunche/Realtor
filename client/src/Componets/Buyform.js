...
const Buying = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    fetch('http://127.0.0.1:5555/buyform', {
      method: 'POST',
      headers: {
...
{currentQuestionIndex === 1 && (
  <div className="question">
    <label htmlFor="file">{questions[currentQuestionIndex - 1]}</label>
    <input
      type="file"
      name="file_upload"
      id="form_button" 
    ...
    >
      ...
      {currentQuestionIndex === questions.length - 1 && (
        ...
        <div className="">
          ...
          {currentQuestionIndex < questions.length && currentQuestionIndex !== 34 && currentQuestionIndex !== 33 && (
            <input 
              type="button" 
              value="Next" 
              id="form_button" 
