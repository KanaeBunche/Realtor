...
function Serve() {
  ...
  <h1 className='title1 titlecenter'>Here to Serve You</h1>
  <subtitle className="sub subcenter"> New Journey Starts Here</subtitle>
  <div className='arrow-container'>
  <svg className="arrows arrows-right" width="103" height="103" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
